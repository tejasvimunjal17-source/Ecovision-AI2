...
SUPABASE_STORAGE_BUCKET = _get("SUPABASE_STORAGE_BUCKET", "ecovision-media")

# ---- Admin bootstrap (optional) ----
ADMIN_EMAIL = _get("ADMIN_EMAIL")
ADMIN_PASSWORD = _get("ADMIN_PASSWORD")
ADMIN_FIRST_NAME = _get("ADMIN_FIRST_NAME", "EcoVision")
ADMIN_LAST_NAME = _get("ADMIN_LAST_NAME", "Administrator")
