...
if user and st.button("💾 Save this record to my profile"):
    insert("carbon_records", {
        "user_id": user["id"], "transport_kg": transport_co2,
        "electricity_kg": electricity_co2, "plastic_kg": plastic_co2,
        "water_kg": water_co2, "food_kg": food_co2, "waste_kg": waste_co2,
        "total_score": total_co2
    })
    st.success("Saved!")
